...
class AIService6 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 1812)';
        } else {
...
class MessageWidget6 extends StatelessWidget {
    final String message;

    const MessageWidget6(this.message, {Key? key}) : super(key: key);
