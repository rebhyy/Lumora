...
class AIService31 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 4849)';
        } else {
...
class MessageWidget31 extends StatelessWidget {
    final String message;

    const MessageWidget31(this.message, {Key? key}) : super(key: key);
