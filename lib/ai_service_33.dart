...
class AIService33 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 5861)';
        } else {
...
class MessageWidget33 extends StatelessWidget {
    final String message;

    const MessageWidget33(this.message, {Key? key}) : super(key: key);
