...
class AIService11 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 2575)';
        } else {
...
class MessageWidget11 extends StatelessWidget {
    final String message;

    const MessageWidget11(this.message, {Key? key}) : super(key: key);
