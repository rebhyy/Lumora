...
class AIService36 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 3426)';
        } else {
...
class MessageWidget36 extends StatelessWidget {
    final String message;

    const MessageWidget36(this.message, {Key? key}) : super(key: key);
