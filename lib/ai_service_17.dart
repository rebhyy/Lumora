...
class AIService17 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 6126)';
        } else {
...
class MessageWidget17 extends StatelessWidget {
    final String message;

    const MessageWidget17(this.message, {Key? key}) : super(key: key);
