...
class AIService37 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 5926)';
        } else {
...
class MessageWidget37 extends StatelessWidget {
    final String message;

    const MessageWidget37(this.message, {Key? key}) : super(key: key);
