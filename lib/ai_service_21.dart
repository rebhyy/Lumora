...
class AIService21 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 4029)';
        } else {
...
class MessageWidget21 extends StatelessWidget {
    final String message;

    const MessageWidget21(this.message, {Key? key}) : super(key: key);
