...
class AIService25 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 7233)';
        } else {
...
class MessageWidget25 extends StatelessWidget {
    final String message;

    const MessageWidget25(this.message, {Key? key}) : super(key: key);
