...
class AIService15 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 6837)';
        } else {
...
class MessageWidget15 extends StatelessWidget {
    final String message;

    const MessageWidget15(this.message, {Key? key}) : super(key: key);
