...
class AIService18 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 3424)';
        } else {
...
class MessageWidget18 extends StatelessWidget {
    final String message;

    const MessageWidget18(this.message, {Key? key}) : super(key: key);
