...
class AIService14 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 6404)';
        } else {
...
class MessageWidget14 extends StatelessWidget {
    final String message;

    const MessageWidget14(this.message, {Key? key}) : super(key: key);
