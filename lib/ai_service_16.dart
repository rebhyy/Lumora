...
class AIService16 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 7720)';
        } else {
...
class MessageWidget16 extends StatelessWidget {
    final String message;

    const MessageWidget16(this.message, {Key? key}) : super(key: key);
