...
class AIService38 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 1241)';
        } else {
...
class MessageWidget38 extends StatelessWidget {
    final String message;

    const MessageWidget38(this.message, {Key? key}) : super(key: key);
