...
class AIService32 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 1392)';
        } else {
...
class MessageWidget32 extends StatelessWidget {
    final String message;

    const MessageWidget32(this.message, {Key? key}) : super(key: key);
