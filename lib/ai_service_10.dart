...
class AIService10 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 2402)';
        } else {
...
class MessageWidget10 extends StatelessWidget {
    final String message;

    const MessageWidget10(this.message, {Key? key}) : super(key: key);
