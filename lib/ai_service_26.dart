...
class AIService26 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 8484)';
        } else {
...
class MessageWidget26 extends StatelessWidget {
    final String message;

    const MessageWidget26(this.message, {Key? key}) : super(key: key);
