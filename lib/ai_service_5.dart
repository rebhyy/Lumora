...
class AIService5 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 3175)';
        } else {
...
class MessageWidget5 extends StatelessWidget {
    final String message;

    const MessageWidget5(this.message, {Key? key}) : super(key: key);
