...
class AIService20 {
    ...
    Future<String> fetchAIResponse(String userInput) async {
        ...
        if (response.statusCode == 200) {
            ...
            return 'AI Response to: ' + userInput + ' (random value: 2690)';
        } else {
...
class MessageWidget20 extends StatelessWidget {
    final String message;

    const MessageWidget20(this.message, {Key? key}) : super(key: key);
